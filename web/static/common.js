...
async function api(path, options) {
  ...
  try {
    res = await fetch(path, {
      ...
      headers: headers,
      body: opts.body !== undefined && !(opts.body instanceof FormData) ? JSON.stringify(opts.body) : opts.body,
    });
  } catch (e) {
...
function loadSquareSdk(environment) {
  return new Promise(function (resolve, reject) {
    ...
    s.onload = function () {
      window.Square ? resolve(window.Square) : reject(new Error("Square SDK loaded but unavailable."));
    };
    s.onerror = function () {
